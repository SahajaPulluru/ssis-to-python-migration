-- =============================================================================
-- Data Quality Checks — Run on Target Data Warehouse after migration
-- =============================================================================
...
FROM production.fact_order f
LEFT JOIN production.dim_customer d
...
SELECT 'fact_order orphan order_date_key' AS check_name,
       COUNT(*) AS orphan_count
FROM production.fact_order f
LEFT JOIN production.dim_date d
...
FROM production.dim_customer c1
INNER JOIN production.dim_customer c2
  ON c1.customer_id = c2.customer_id
  AND c1.effective_end_date < c2.effective_start_date
  AND c1.is_current = false
WHERE NOT EXISTS (
    SELECT 1 FROM production.dim_customer c3
